  ...
  return (
    <PopoverPrimitive.Root>
      ...
      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-background'>
